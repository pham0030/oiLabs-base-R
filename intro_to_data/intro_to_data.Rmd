...
table(cdc$gender)
table(cdc$exerany)
sum(cdc$genhlth == "excellent")/dim(cdc)[1]
```

Answer: Proportion of the sample reports being in excellent health: 0.23285
...
Answer: Male is more likely to be smoker than female
