...
Answer: number of successes and failures > 10, with independence variables assumption,
the conditions for infrence are satisfied.

4.  Write the hypotheses for testing if the average weights of babies born to 
smoking and non-smoking mothers are different.

Answer: $H_{o}$: the average weights of babies born to smoking and non-smoking
mothers are the same, $\mu_{smoke} = \mu_{non-smoke}$ . $H_{a}$: the average weights of babies born to smoking and non-smoking
mothers are different, $\mu_{smoke} \neq \mu_{non-smoke}$
...
```{r ci-95-weeks, eval=TRUE}
inference(y=nc$weight, est="mean", type="ci", conflevel = 0.95,
          method="theoretical")
```
...
```{r ci-90-weeks, eval=TRUE}
inference(y=nc$weight, est="mean", type="ci", conflevel = 0.90,
          method="theoretical")
```
