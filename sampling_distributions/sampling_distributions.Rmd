...
```{r mean-samp-more, eval=FALSE}
samp2 <- sample(area, 50)
hist(samp2)
mean(samp2)
```

```{r mean-samp-more-2, eval=FALSE}
...
Answer: normally distributed centered at population means, the distribution
...
```
Answer: `sample_means150` has smaller spread
